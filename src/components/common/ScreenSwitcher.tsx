...
import { Smartphone, Layers, RotateCcw, ExternalLink } from 'lucide-react';
...
export const ScreenSwitcher: React.FC<ScreenSwitcherProps> = ({
  ...
  const screens: { id: ScreenId; label: string; group: string; number: number }[] = [
    ...
    { id: 'otp_auth', label: '2. OTP Sign In', group: 'Onboarding', number: 2 },
    { id: 'home', label: '3. Artisan Home', group: 'Main', number: 3 },
    { id: 'take_photo', label: '4. Step 1: Camera', group: 'AI Listing Flow', number: 4 },
    { id: 'review_photo', label: '5. Step 2: Review Photo', group: 'AI Listing Flow', number: 5 },
    { id: 'analyzing_craft', label: '6. Step 3: AI Scanner', group: 'AI Listing Flow', number: 6 },
    { id: 'review_listing', label: '7. Step 4: Craft Draft', group: 'AI Listing Flow', number: 7 },
    { id: 'smart_pricing', label: '8. Step 5: Smart Pricing', group: 'AI Listing Flow', number: 8 },
    { id: 'final_verify', label: '9. Step 6: Verify & Publish', group: 'AI Listing Flow', number: 9 },
    { id: 'product_live', label: '10. Published Live', group: 'AI Listing Flow', number: 10 },
    { id: 'my_shop', label: '11. My Shop', group: 'Shop & Ops', number: 11 },
    { id: 'orders', label: '12. Your Orders', group: 'Shop & Ops', number: 12 },
    { id: 'earnings', label: '13. Earnings & WhatsApp', group: 'Shop & Ops', number: 13 },
    { id: 'profile', label: '14. Profile & Voice', group: 'Shop & Ops', number: 14 },
  ];
