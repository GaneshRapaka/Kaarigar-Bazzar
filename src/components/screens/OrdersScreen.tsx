...
import { Package, Truck, CheckCircle2, Clock, MapPin, ChevronRight, Box } from 'lucide-react';
...
export const OrdersScreen: React.FC<OrdersScreenProps> = ({ orders, onPackOrder }) => {
  ...
  return (
    <div className="flex-1 flex flex-col p-4 bg-artisan-bg overflow-y-auto select-none space-y-4">
      {/* Top Header */}
      <div className="pt-1">
        <h1 className="text-xl font-extrabold text-artisan-text tracking-tight">Your Orders</h1>
      </div>
      ...
      <div className="flex items-center gap-1 p-1 bg-white rounded-2xl border border-artisan-border shadow-soft overflow-x-auto scrollbar-none">
        <button
          ...
          className={`flex-1 py-1.5 px-2 rounded-xl text-[11px] font-bold whitespace-nowrap transition ${
            activeTab === 'new'
      ...
      <div className="space-y-2.5">
        <div className="flex items-center justify-between px-1">
          ...
          <span className="text-[10px] text-terracotta font-bold">2 Pending</span>
        </div>
      ...
      <div className="space-y-2.5 pt-1">
        <div className="flex items-center justify-between px-1">
          ...
          <span className="text-[10px] text-forest font-bold">Fulfilled</span>
        </div>
